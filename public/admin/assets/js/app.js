            ...
            0 < e.querySelectorAll(".notification-item").length
                ...
                : (e.querySelector(".view-all") &&
                  ...
                  e.querySelector(".empty-notification-elem") ||
                      (e.innerHTML +=
                          '<div class="empty-notification-elem">\t\t\t\t\t\t\t<div class="w-25 w-sm-50 pt-3 mx-auto">\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class="text-center \t\t<h6 class="fs-18 fw-semibold lh-base">Hey! Yopb-5 mt-2">\t\t\t\t\t\tu have no any notifications </h6>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>'));
        });
    }
    function W() {
        var e;
